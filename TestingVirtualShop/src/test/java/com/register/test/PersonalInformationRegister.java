...
public class PersonalInformationRegister extends Base {
	...
	By LocError = By.xpath("//*[@id=\"center_column\"]/div/p");
	By BtnRegister = By.id("submitAccount");

	public PersonalInformationRegister(WebDriver driver) {
		super(driver);
